define(['backbone', 'jquery', 'jquerycsv'], function($B, $, csv) {
    // this works technically, but the map is just a bunch of crazy lines
    // after spending some 3 hours experimenting with different geojson
    // maps, I found http://d3-geomap.github.io/map/choropleth/us-states/
    // which worked, see MapViewD3. 
    // 
    // Links found during investigation
    // http://mapshaper.org/
